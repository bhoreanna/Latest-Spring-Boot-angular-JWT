...
public class ScreenMaster {
	...
	public String toString() {
		return "ScreenMaster [screenMasterUid=" + screenMasterUid + ", screenMasterId=" + screenMasterId
				+ ", screenName=" + screenName + ", createdBy=" + createdBy + ", modifiedBy=" + modifiedBy
				+ ", createdDate=" + createdDate + ", modifyDate=" + modifyDate + ", screenStatus=" + screenStatus
